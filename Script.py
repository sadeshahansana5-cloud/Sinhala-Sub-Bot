class script(object):
    START_TXT = """<b><u>🚩 𝗦𝗶𝗻𝗵𝗮𝗹𝗮 𝗦𝘂𝗯 𝗕𝗼𝘁 🚩</u></b>

<b>ʜᴇʏ {}, {}</b>

<b>🤖 ɪ ᴀᴍ <a href=https://t.me/{}>{}</a>, ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟ sɪɴʜᴀʟᴀ sᴜʙ ᴅᴏᴡɴʟᴏᴀᴅ ʙᴏᴛ ᴡɪᴛʜ ᴜʟᴛʀᴀ ʙᴏᴛs.</b>
"""


    GSTART_TXT = """<b>🚩 𝗦𝗶𝗻𝗵𝗮𝗹𝗮 𝗦𝘂𝗯 𝗕𝗼𝘁 🚩</b>
...
<blockquote>👇 नीचे दिए गए विकल्पों में से movie के नाम की सही spelling चुनें</blockquote>"""
    ...
    DEL_MSG = """⚠️ ᴛʜɪꜱ sᴜʙᴛɪᴛʟᴇ ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ <b><u><code>{}</code></u></b>
